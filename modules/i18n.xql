...
(:~
    ...
    : see http://demo.exist-db.org/exist/apps/demo/examples/special/i18n.html
...
(:~
 : A 1-arity-version of the original i18n:process() with default values for catalogue path and default language 
 :
...
declare function i18n:process($nodes as node()*) {
    i18n:process($nodes, '', ecmCore:get-default-i18n-catalogue-dir(), ecmCore:get-default-i18n-language())
};
